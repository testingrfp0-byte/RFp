...
from app.services.llm_service import extract_text_from_pdf,extract_company_background_from_rfp,extract_questions_with_llm,summarize_results_with_llm,generate_search_queries,search_with_serpapi,analyze_answer_score_only ,query_vector_db,client,parse_rfp_summary,build_company_background_prompt,build_proposal_prompt,get_embedding,extract_text_from_file,get_similar_context
...
from app.utils.admin_function import process_rfp_file,fetch_file_details,process_library_upload,get_all_users,get_assigned_users,get_rfp_details,assign_multiple_review,get_reviewers_by_file_service,get_user_by_id_service,check_submissions_service,get_assign_user_status_service,delete_rfp_document_service,remove_user_service,filter_question_service,admin_filter_questions_by_status_service,analyze_overall_score_service,view_rfp_document_service,edit_question_by_admin_service,update_profile_service,delete_reviewer_service,regenerate_answer_with_chat_service,reassign_reviewer_service
...
def get_rfp_details(
    ...
    return get_rfp_details(document_id, status, db)
